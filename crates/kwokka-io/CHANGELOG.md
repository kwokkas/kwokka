...
## [0.0.2](https://github.com/kwokkas/kwokka/compare/kwokka-io-v0.0.1...kwokka-io-v0.0.2) - 2026-08-10

### Bug fixes

- put main back to green on the Darwin check ([#336](https://github.com/kwokkas/kwokka/pull/336))
- macOS denies warnings once the ring is gated ([#323](https://github.com/kwokkas/kwokka/pull/323))
- Darwin needs a second call for close-on-exec ([#322](https://github.com/kwokkas/kwokka/pull/322))
- compile the io crate where no backend exists ([#317](https://github.com/kwokkas/kwokka/pull/317))
...
- every reclaim path yields what it removed ([#341](https://github.com/kwokkas/kwokka/pull/341))
- a deferred operation finishes in userspace ([#339](https://github.com/kwokkas/kwokka/pull/339))
- one descriptor answers with exactly one slot ([#337](https://github.com/kwokkas/kwokka/pull/337))
- duplicate a descriptor before the first try ([#333](https://github.com/kwokkas/kwokka/pull/333))
